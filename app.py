...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "lumen-dashboard-secret-2026")
...
# ── Google Sheets ─────────────────────────────────────────────────────────────
SPREADSHEET_ID = "12Dcp39XlVY7FHlR0x0MO_qVHHMjn42CDq8TFiJOjYlg"
SCOPES = [
...
HOLIDAY_KEYWORDS = ["past"]
LIVE_KEYWORDS    = ["live", "active", "tof"]
